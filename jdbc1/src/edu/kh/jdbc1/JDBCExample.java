...
//															(Java에 기본 내장된 인터페이스)
	...
	//================ 09 05 5교시
		...
		// * Java와 DB사이를 연결해주는 통로(Stream과 유사함)
		
		Statement stmt = null;
		// Connection을 통해 
		// SQL문을 DB에 전달하여 실행하고
		// 생성된 결과(Select : ResultSet, 성공한 행의 개수(INSERT UPDATE DELETE))
		//를 반환(->Java)하는데 사용되는 개체
...
//		System.out.println(conn);
		...
		// 5. 생성된 Statement객체에  sql을 적재하여 실행한 후 
		// 결과를 반환받아와서 rs변수에 저장
